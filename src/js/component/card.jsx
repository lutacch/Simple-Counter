  ...
  useEffect(()=> {
     ...
     <div className="container-fluid p-5">
         ...
         <div className="card-body">
           <h5 className="card-title position-absolute top-50 start-50 translate-middle fs-1">{counterHours2.toString()}</h5>
         </div>
         </div>
 
         <div className="card bg-dark text-primary me-2">
         <div className="card-body">
           <h5 className="card-title position-absolute top-50 start-50 translate-middle fs-1">{counterHours1.toString()}</h5>
         </div>
         </div>
 
         <div className="card bg-dark text-warning me-2">
         <div className="card-body">
           <h5 className="card-title position-absolute top-50 start-50 translate-middle fs-1">{counterMinutes2.toString()}</h5>
         </div>
         </div>
 
         <div className="card bg-dark text-warning me-2">
         <div className="card-body">
           <h5 className="card-title position-absolute top-50 start-50 translate-middle fs-1">{counterMinutes1.toString()}</h5>
         </div>
         </div>
 
         <div className="card bg-dark text-danger me-2">
         <div className="card-body">
           <h5 className="card-title position-absolute top-50 start-50 translate-middle fs-1">{counterSeconds2.toString()}</h5>
         </div>
         </div>
 
         <div className="card bg-dark text-danger me-2">
         <div className="card-body">
           <h5 className="card-title position-absolute top-50 start-50 translate-middle fs-1">{counterSeconds1.toString()}</h5>
         </div>
         </div>
         </div>
         <a href="#" onClick={() => setCounter1(0)} className="btn btn-success d-flex justify-content-center mt-3">Reset Button</a>
     </div>
     );
